...
function MoveToTopButton() {
    ...
    return (
        <div className={"py-3 fixed bottom-4 z-10 hover:bottom-6 transition-all duration-500 " + buttonCss}
             onClick={moveToTop}>
            <button
                className="p-2 rounded-md border-2 border-white mt-7 cursor-pointer relative flex max-md:text-lg items-center justify-center overflow-hidden transition-all">
